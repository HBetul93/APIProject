...
public class Get11 extends DummyApiBaseUrl {
  ...
  */
    ...
    @Test
    public void get11() throws IOException { // we used trows declaration because this class is only for test
       ...
       // response.prettyPrint();
        ...
        ObjectMapper obj = new ObjectMapper(); //we use it for serialization and deserialization

        //we do deserialization using ObjectMapper
        OuterData outerData = obj.readValue(response.asString(),OuterData.class); // ObjectMapper is translator. IT will read the data and convert it for us
        // it gets the data from RESPONSE
        // then it convert the data to OuterData
    ...
    public void get12(){
        ...
        Gson gson = new Gson(); // is also a translator. like ObjectMapper
