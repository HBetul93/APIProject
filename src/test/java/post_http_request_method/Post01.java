...
public class Post01 extends HerokuAppBaseUrl {
    ...
    */
    ...
    public void post01(){
        ...
        //we want to create smt. so, we need the body, we need to content type
        //Send the Post request and get the response
        Response response = given().spec(spec).contentType(ContentType.JSON).body(expectedData).when().post("/{first}");
        //response.prettyPrint();
        //Do the validation
        Map<String, Object> actualData = response.as(HashMap.class);
        //                                          we are converting the Object to Map here.
        ...
        //in an Object we have ALl data types: String, int, double,
    }
}
